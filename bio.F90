...
2   WRITE (ERROR_UNIT,'(2A)') 'BIO_CLOSE   :', TRIM(MSG)
  ...
  SUBROUTINE BIO_WRITE_D1(U, N, A, INFO)
    ...
    WRITE (UNIT=U, IOSTAT=INFO, IOMSG=MSG, ERR=3) A
    RETURN
3   WRITE (ERROR_UNIT,'(2A)') 'BIO_WRITE_D1:', TRIM(MSG)
    FLUSH(ERROR_UNIT)
  ...
  SUBROUTINE BIO_WRITE_D2(U, M, N, A, INFO)
    ...
    RETURN
4   WRITE (ERROR_UNIT,'(2A)') 'BIO_WRITE_D2:', TRIM(MSG)
    FLUSH(ERROR_UNIT)
  ...
  SUBROUTINE BIO_READ_D1(U, N, A, INFO)
    ...
    RETURN
5   WRITE (ERROR_UNIT,'(2A)') 'BIO_READ_D1 :', TRIM(MSG)
    FLUSH(ERROR_UNIT)
  ...
  SUBROUTINE BIO_READ_D2(U, M, N, A, INFO)
    ...
    RETURN
6   WRITE (ERROR_UNIT,'(2A)') 'BIO_READ_D2 :', TRIM(MSG)
    FLUSH(ERROR_UNIT)
